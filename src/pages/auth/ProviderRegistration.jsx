      ...
      <div className="auth-layout container bg-light" style={{ paddingTop: '3rem', paddingBottom: '3rem' }}>
         <div className="auth-card card" style={{ maxWidth: '800px', margin: '0 auto', padding: '2.5rem' }}>
            ...
            <form onSubmit={handleSubmit}>
               ...
               {step === 3 && (
                  <div className="registration-step">
                     ...
                     <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                        ...
                        <hr style={{ borderColor: 'var(--light-gray)', margin: '1rem 0' }} />
               ...
               <div style={{ display: 'flex', flexWrap: 'wrap-reverse', gap: '1rem', marginTop: '2.5rem', justifyContent: 'flex-end' }}>
                  {step > 1 && (
                     <button type="button" className="btn btn-outline" style={{ flex: '1 1 200px', padding: '0.75rem' }} onClick={() => setStep(step - 1)}>Back</button>
                  )}

                  <button type="submit" className="btn btn-primary" style={{ flex: step === 1 ? '0 1 auto' : '1 1 200px', padding: '0.75rem 2rem' }}>
